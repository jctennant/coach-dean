...
- For high-volume athletes (FITNESS TIER: HIGH VOLUME), week 1 MUST include at least one quality session (tempo, intervals, strides, or hill repeats) alongside the easy volume. An athlete running 30+ mi/week should NOT get an all-easy first week — they already have the aerobic base. Prescribing all easy miles for an established runner is sandbagging them.
