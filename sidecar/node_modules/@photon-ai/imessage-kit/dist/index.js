...
import { existsSync, readdirSync, lstatSync, rmSync, watch, statSync } from 'fs';
...
var SANDBOX_SAFE_DIRS_ABS = MESSAGES_APP_SANDBOX_SAFE_DIRS.map((dir) => join(homedir(), dir));
var TEMP_WRITE_DIR_ABS = join(homedir(), MESSAGES_APP_TEMP_WRITE_DIR);
...
var TEMP_DIR = join(homedir(), MESSAGES_APP_TEMP_WRITE_DIR);
var DEFAULTS = {
  maxAge: 10 * 60 * 1e3,
...
export { BOUNDS, ChatId, ConfigError, DatabaseError, IMessageError, IMessageSDK, PlatformError, SendError, attachmentExists, definePlugin, getAttachmentExtension, getDefaultDatabasePath, isAudioAttachment, isImageAttachment, isVideoAttachment, requireMacOS, resolveTarget };
