...
11. strava_scope_honest (boolean | null): Only score when Strava was connected. Coach Dean reads Strava activities and texts a coaching note by SMS — it does NOT write anything back to the Strava activity itself (no description/comment is posted to Strava). Does every Strava pitch/connection message in the transcript describe this accurately (e.g. "I'll read your runs and text you a coaching note after each one")? False if any message claims Dean writes/adds/posts a note "to" the Strava activity, "to it", or otherwise implies something is written back to Strava — that overstates what actually happens. Null if Strava was skipped.
